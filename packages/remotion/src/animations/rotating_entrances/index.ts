...
export const rotateIn = (progress: number) => ({
	transform: `rotate3d(0, 0, 1, ${rotateInRotateZ(progress)}deg)`,
	opacity: rotateInOpacity(progress),
});

export const rotateInDownLeft = (progress: number) => ({
	transform: `rotate3d(0, 0, 1, ${rotateInDownLeftRotateZ(progress)}deg)`,
	opacity: rotateInOpacity(progress),
});

export const rotateInDownRight = (progress: number) => ({
	transform: `rotate3d(0, 0, 1, ${rotateInDownRightRotateZ(progress)}deg)`,
	opacity: rotateInOpacity(progress),
});

export const rotateInUpLeft = (progress: number) => ({
	transform: `rotate3d(0, 0, 1, ${rotateInUpLeftRotateZ(progress)}deg)`,
	opacity: rotateInOpacity(progress),
});

export const rotateInUpRight = (progress: number) => ({
	transform: `rotate3d(0, 0, 1, ${rotateInUpRightRotateZ(progress)}deg)`,
	opacity: rotateInOpacity(progress),
});
